...
public class AuditCollectorTaskTest {
    ...
    public void getCollectAuditStatusData(){
        ...
        AuditResult auditResult1 = new AuditResult(ObjectId.get(),"auditTestDashboard" , "CARD", "ASVC","BAP" ,"praveen" ,null ,AuditType.CODE_QUALITY ,"OK","OK" ,null,null ,7883L );
        ...
        recentDashboards.forEach(dashboard -> {
            ...
            if (!auditResults.isEmpty()) {
                ...
                auditresult2.forEach(auditResult -> {
                    ...
                    assertTrue(auditResult.getAuditTypeStatus().equals("OK"));
                    assertTrue(auditResult.getAuditStatus().equals("OK"));
                });
